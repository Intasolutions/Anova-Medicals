...
const ReceiptTemplate = ({ sale }) => (
    <div className="font-mono text-xs leading-relaxed uppercase text-slate-900 p-8">
        <div className="text-center space-y-1 mb-6">
            <h1 className="text-xl font-black tracking-widest uppercase">DEMO HOSPITAL</h1>
            <div className="flex flex-col items-center gap-1 text-xs font-bold text-slate-500">
                <p>123 Health Ave</p>
                <div className="flex items-center justify-center gap-4">
                    <span>LIC: DEMO-LIC-1234</span>
                    <span>PH: 555-0198</span>
                </div>
            </div>
        ...
        <p className="text-center mt-8 text-xs text-slate-400">Get Well Soon • Generated by Demo CMS</p>
    </div>
);
