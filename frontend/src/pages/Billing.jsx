                ...
                <div className="flex flex-col h-full justify-between min-h-screen">
                    <div>
                        ...
                        <div className="flex justify-between items-start mb-8 border-b-2 border-slate-900 pb-6">
                            <div>
                                <h1 className="text-3xl font-black text-slate-900 tracking-widest uppercase">DEMO HOSPITAL</h1>
                                ...
                                <div className="mt-4 text-xs text-slate-600 font-bold space-y-1">
                                    <p>123 Health Ave</p>
                                    <p>Metro City - 10001</p>
                                    <p>Ph: 555-0198</p>
                                    <p>GST NO : DEMO-GST-123</p>
                    ...
                    <div>
                        <div className="flex flex-col items-center mt-8 pt-2">
                            ...
                            <div className="w-full flex justify-end px-12">
                                <div className="text-center">
                                    ...
                                    <p className="text-xs font-bold text-slate-900">For DEMO HOSPITAL</p>
                        ...
                        <div className="mt-8 border-t border-dashed border-slate-300 pt-2 flex justify-between items-center px-8">
                            <p className="text-[8px] font-bold text-slate-400 uppercase tracking-widest">Generated by Demo CMS</p>
